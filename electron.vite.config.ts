...
// Privacy-hardened fork: product telemetry is removed, so the PostHog write
// key is gone. ORCA_BUILD_IDENTITY remains because the (separate) diagnostics
// lane still reads it. Ambient declarations live in
